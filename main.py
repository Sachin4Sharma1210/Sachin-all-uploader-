...
photologo = 'https://files.catbox.moe/v03e90.jpg' #https://envs.sh/GV0.jpg
photoyt = 'https://files.catbox.moe/v03e90.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://files.catbox.moe/v03e90.jpg'
photozip = 'https://files.catbox.moe/v03e90.jpg'


# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/Avigat1210")]])
...
image_urls = [
    "https://files.catbox.moe/v03e90.jpg",
    "https://files.catbox.moe/v03e90.jpg",
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [{CREDIT}](https://t.me/P_JANGID7)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
